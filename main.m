...
carriers = OfdmMethod(modulated_data);              % OFDM schemes to allocated QAM data on carries
...
%------------------WITH NOISY CHANNEL---------------------
s = awgn(s,10,'measured');                                                   % Add white Gaussian noise.
...
title('Symbol Error Rate for Different Jitter rms At AWGN Channel SNR 10');
